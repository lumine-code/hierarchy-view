  ...
  activate() {
    ...
    this.subscriptions.add(
      lumine.commands.add("lumine-text-editor:not([mini])", {
        "hierarchy-view:incoming-calls": () => this.showHierarchy("call", "up"),
        "hierarchy-view:outgoing-calls": () => this.showHierarchy("call", "down"),
        "hierarchy-view:supertypes": () => this.showHierarchy("type", "up"),
        "hierarchy-view:subtypes": () => this.showHierarchy("type", "down"),
      }),
